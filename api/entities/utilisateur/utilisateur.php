...
function createUtilisateur($data) {
    ...
    $required_keys = [
        ...
        'prestataire_accept', 'prestataire', 'prestataire_refus', 'raison_refus'
    ];
    ...
    $sql = "INSERT INTO utilisateur (nom, prenom, email, mot_de_passe, date_inscription, date_naissance, 
            ...
            bailleur, bailleur_refus, voyageur, prestataire_accept, prestataire, prestataire_refus, raison_refus)
