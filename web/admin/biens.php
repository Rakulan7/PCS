...
include("log.php");
logActivity("", "page biens.php");

include("function.php");

$db = getDatabase();

$getBienAll = $db->prepare("SELECT * FROM bien");
$getBienAll->execute([]);
$bienAll = $getBienAll->fetchAll(PDO::FETCH_ASSOC);
...
<body>
    ...
    <div class="d-flex justify-content-center mt-3">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" id="all-tab" data-bs-toggle="tab" href="#all">Tout les biens</a>
            </li>
            <li class="nav-item">
